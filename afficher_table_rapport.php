...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="overflow-x: hidden;">
                    ...
                    <div class="col-md-<?php if($_SESSION['user_eteelo_app']['ID_Statut']==3){ echo '2';}else{echo '1';} ?>">
                      <div class="form-group ">
                        ...
                        <div class="col-lg-12">
                          <div class="row">
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="nocTicket" id="nocTicket" value="<?php if(isset($_GET['nocTicket']) && $_GET['nocTicket']!=''){echo $_GET['nocTicket']; } ?>">
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    $(document).ready(function() {
        ...
        $('#iframe').attr('src', "table_rapport.php?User="+$('#utilisateur').val()+'&siteId='+$('#siteId').val()+'&nocTicket='+$('#nocTicket').val()+'&dateRapport='+dateRap);
    });
  ...
  $(function() {
    ...
    $('#btn_ajouter').click(function(e){
      ...
      let dateRapport = $('#dateRapport').val();
      dateRap = dateRapport.replace(/\//g, "-");
      window.location.replace('ajouter_rapport_journalier.php?User='+$('#utilisateur').val()+'&siteId='+$('#siteId').val()+'&nocTicket='+$('#nocTicket').val()+'&dateRapport='+dateRap);
    })
