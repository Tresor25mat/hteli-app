<?php
    ...
    $query="SELECT * FROM table_rapport_janitorial INNER JOIN site ON table_rapport_janitorial.ID_Site=site.ID_Site INNER JOIN province ON site.ID_Prov=province.ID_Prov INNER JOIN type_site ON table_rapport_janitorial.ID_Type=type_site.ID_Type WHERE table_rapport_janitorial.ID_Rapport!=0";
    if(isset($_GET['User']) && $_GET['User']!=''){
        $query.=" AND table_rapport_janitorial.ID_Utilisateur=".$_GET['User'];
    }
    if(isset($_GET['SiteType']) && $_GET['SiteType']!=''){
        $query.=" AND table_rapport_janitorial.ID_Type=".$_GET['SiteType'];
    }
    ...
    if(isset($_GET['dateRapport']) && $_GET['dateRapport']!=''){
        $query.=" AND table_rapport_janitorial.Date_Rapport='".date('Y-m-d', strtotime($_GET['dateRapport']))."'";
    }
    $query.=" ORDER BY table_rapport_janitorial.Date_Rapport";
    $req=$pdo->query($query);
    $Total=$req->rowCount();
    $totalparpage=10;
...
<?php } ?>
    ...
    <?php while($selections=$selection->fetch()){$Nbr++; ?>
        <tr class="odd gradeX" style="background: transparent;">
            ...
            <td><!-- <center> --><?php echo strtoupper(stripslashes($selections['Design_Type'])); ?></td>
    ...
    <?php } ?>
              ...
              <ul class="pagination ms-auto">
                                ...
                                if($pageCourante>1){
                                    $page=$pageCourante-1;
                                    echo '<li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$page.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="15 6 9 12 15 18" /></svg>Previous</a></li>';
                                }else{
                                ...
                                if($pagesTotales>3){
                                    ...
                                    if($pageCourante==1){
                                        echo '<li class="page-item"><a class="page-link" href="#">1</a></li><li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$pageNexte.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$pageTrois.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageTrois.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==2){
                                        echo '<li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$pagePrecedente.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$pageNexte.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==$pagesAvantTotales){
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$pagePrecedente.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$pageNexte.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageNexte.'</a></li>';
                                    }else if($pageCourante==$pagesTotales){
                                            echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$pageAvantPrecedente.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageAvantPrecedente.'</a></li><li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$pagePrecedente.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li>';
                                    }else{
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$pagePrecedente.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$pageNexte.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>'; 
                                    }
                                }else{
                                    for ($i=1; $i <= $pagesTotales ; $i++) { 
                                        if ($i==$pageCourante) {
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$i.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">'.$i.'</a></li>';
                                        }
                                    } 
                                }
                                if($pagesTotales>$pageCourante){
                                    $page=$pageCourante+1;
                                    echo '<li class="page-item"><a class="page-link" href="table_janitorial.php?page='.$page.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&SiteType='.$_GET['SiteType'].'&dateRapport='.$_GET['dateRapport'].'">Next<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="9 6 15 12 9 18" /></svg></a></li>';
                                }else{
