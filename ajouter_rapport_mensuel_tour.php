...
<html lang="en">
  <head>
    ...
    <title>New Monthly Tower Inspection | <?php echo $app_infos['Design_App']; ?></title>
    <!-- CSS files -->
    <!-- DataTables CSS -->
                                    ...
                                    <div class="col-md-3" style="margin-bottom: 5px;">
                                      ...
                                      <div class="col-md-3" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="pm_ref" type="text" name="pm_ref">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-3" style="margin-bottom: 5px">
                                        ...
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <select name="tower_type" id="tower_type" class="form-control">
                                                ...
                                                <option value="<?php echo($tower_types['ID_Tower_Type']); ?>"><?php echo strtoupper($tower_types['Design_Tower_Type']); ?></option>
                                                <?php } ?>
                                            </select>
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                              <div class="input-group">
                                                <input class="form-control " id="tower_ht" type="number" name="tower_ht" min="0" style="border-top-right-radius: 0; border-bottom-right-radius: 0">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="test_result1" type="text" name="test_result1">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                      ...
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="ncr_if_any1" type="text" name="ncr_if_any1">
                                          </div>
                                        </div>
                                      </div>
                                </div>
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="test_result2" type="text" name="test_result2">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                      ...
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="ncr_if_any2" type="text" name="ncr_if_any2">
                                          </div>
                                        </div>
                                      </div>
                                </div>
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="test_result3" type="text" name="test_result3">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                      ...
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="ncr_if_any3" type="text" name="ncr_if_any3">
                                          </div>
                                        </div>
                                      </div>
                                </div>
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="test_result4" type="text" name="test_result4">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                      ...
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="ncr_if_any4" type="text" name="ncr_if_any4">
                                          </div>
                                        </div>
                                      </div>
                                </div>
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="test_result5" type="text" name="test_result5">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                      ...
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="ncr_if_any5" type="text" name="ncr_if_any5">
                                          </div>
                                        </div>
                                      </div>
                                </div>
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="test_result6" type="text" name="test_result6">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                      ...
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="ncr_if_any6" type="text" name="ncr_if_any6">
                                          </div>
                                        </div>
                                      </div>
                                </div>
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="test_result7" type="text" name="test_result7">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                      ...
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="ncr_if_any7" type="text" name="ncr_if_any7">
                                          </div>
                                        </div>
                                      </div>
                                </div>
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="test_result8" type="text" name="test_result8">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                      ...
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="ncr_if_any8" type="text" name="ncr_if_any8">
                                          </div>
                                        </div>
                                      </div>
                                </div>
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="test_result9" type="text" name="test_result9">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                      ...
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="ncr_if_any9" type="text" name="ncr_if_any9">
                                          </div>
                                        </div>
                                      </div>
                                </div>
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="test_result10" type="text" name="test_result10">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                      ...
                                      <div class="col-md-4" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="ncr_if_any10" type="text" name="ncr_if_any10">
                                          </div>
                                        </div>
                                      </div>
                                </div>
            ...
            $.ajax({
                    ...
                    success:function(retour){
                        ...
                        if(retour==1){
                            ...
                            dateRap = dateRapport.replace(/\//g, "-");
                            window.location.replace('afficher_table_rapport_mensuel_tour.php?User='+$('#User').val()+'&siteId='+$('#siteId').val()+'&TowerType='+$('#TowerType').val()+'&dateRapport='+dateRap);
                        }else{
