    ...
    $smsCount = substr($responses[22], 1, 1);
 	if($tel=$sel_tel->fetch()){
 		...
 		// $insert=$pdo->query("INSERT INTO conversation (ID_Conversation, ID_Utilisateur) VALUES ('".$ID_Conversation."', ".$_SESSION['user_courrier']['ID_Utilisateur'].")");
  		...
  		$insert_participer=$pdo->query("INSERT INTO participer (ID_Participer, ID_Conversation, ID_Telephone, Reponse, smsCount, Command, ID_Utilisateur) VALUES ('".$ID_Participer."', '".$ID_Conversation."', '".$tel['ID_Telephone']."', '".$response."',".$smsCount.", 1, ".$_SESSION['user_courrier']['ID_Utilisateur'].")");
 	}else{
 		...
 		$insert=$pdo->query("INSERT INTO conversation (ID_Conversation, Date_Envoie, ID_Utilisateur) VALUES ('".$ID_Conversation."', Now(), ".$_SESSION['user_courrier']['ID_Utilisateur'].")");
  		...
  		$insert_participer=$pdo->query("INSERT INTO participer (ID_Participer, ID_Conversation, ID_Telephone, Reponse, smsCount, Command, ID_Utilisateur) VALUES ('".$ID_Participer."', '".$ID_Conversation."', '".$ID_Telephone."', '".$response."',".$smsCount.", 1, ".$_SESSION['user_courrier']['ID_Utilisateur'].")");
 	}
	echo "1";
   // echo $response;
 }
