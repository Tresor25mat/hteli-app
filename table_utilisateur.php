                                ...
                                if($pagesTotales>3){
                                    ...
                                    if($pageCourante==1){
                                        ...
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pagePrecedente.'&Pays='.$_GET['Pays'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pageNexte.'">'.$pageNexte.'</a></li>';
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pageAvantPrecedente.'&Pays='.$_GET['Pays'].'">'.$pageAvantPrecedente.'</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pagePrecedente.'&Pays='.$_GET['Pays'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li>';
                                    }else{
                                    ...
                                    for ($i=1; $i <= $pagesTotales ; $i++) { 
                                        if ($i==$pageCourante) {
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$i.'&Pays='.$_GET['Pays'].'">'.$i.'</a></li>'; 
                                        }
                                    } 
                                }
