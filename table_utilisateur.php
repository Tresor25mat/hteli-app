<?php
    ...
    if(isset($_GET['UserName']) && $_GET['UserName']!=''){
      $query.=" AND (UCASE(Prenom) LIKE '%".strtoupper($_GET['UserName'])."%' OR UCASE(Nom) LIKE '%".strtoupper($_GET['UserName'])."%')";
    }
            ...
            <div class="d-flex mt-4">
              <ul class="pagination ms-auto">
                                ...
                                if($pagesTotales>3){
                                    ...
                                    if($pageCourante==1){
                                        echo '<li class="page-item"><a class="page-link" href="#">1</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pageNexte.'&Pays='.$_GET['Pays'].'&UserName='.$_GET['UserName'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pageTrois.'&Pays='.$_GET['Pays'].'&UserName='.$_GET['UserName'].'">'.$pageTrois.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==2){
                                        echo '<li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pagePrecedente.'&Pays='.$_GET['Pays'].'&UserName='.$_GET['UserName'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pageNexte.'&Pays='.$_GET['Pays'].'&UserName='.$_GET['UserName'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                        ...
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pagePrecedente.'&Pays='.$_GET['Pays'].'&UserName='.$_GET['UserName'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pageNexte.'">'.$pageNexte.'</a></li>';
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pageAvantPrecedente.'&Pays='.$_GET['Pays'].'&UserName='.$_GET['UserName'].'">'.$pageAvantPrecedente.'</a></li><li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$pagePrecedente.'&Pays='.$_GET['Pays'].'&UserName='.$_GET['UserName'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li>';
                                    }else{
                                    ...
                                    for ($i=1; $i <= $pagesTotales ; $i++) { 
                                        if ($i==$pageCourante) {
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$i.'&Pays='.$_GET['Pays'].'&UserName='.$_GET['UserName'].'">'.$i.'</a></li>'; 
                                        }
                                    } 
                                }
                                if($pagesTotales>$pageCourante){
                                    $page=$pageCourante+1;
                                    echo '<li class="page-item"><a class="page-link" href="table_utilisateur.php?page='.$page.'&Pays='.$_GET['Pays'].'&UserName='.$_GET['UserName'].'">Next<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="9 6 15 12 9 18" /></svg></a></li>';
                                }else{
