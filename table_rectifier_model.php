<?php
    ...
    $query="SELECT * FROM table_rectifier_model ORDER BY Design_Rectifier_Model";
    $req=$pdo->query($query);
    $Total=$req->rowCount();
    $totalparpage=10;
...
<html lang="fr-FR">
  <head>
    ...
    <title>Rectifier model | <?php echo $app_infos['Design_App']; ?></title>
    <!-- CSS files -->
    <!-- DataTables CSS -->
          ...
          <div class="page-header d-print-none">
            <div class="row g-2 align-items-center">
              ...
              <div class="col-12 col-md-auto ms-auto d-print-none">
                <input type="hidden" name="ID_Rectifier_Model" id="ID_Rectifier_Model">
                <div class="btn-list">
    ...
    <?php } ?>
              ...
              <ul class="pagination ms-auto">
                                ...
                                if($pagesTotales>3){
                                    ...
                                    if($pageCourante==1){
                                        echo '<li class="page-item"><a class="page-link" href="#">1</a></li><li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$pageNexte.'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$pageTrois.'">'.$pageTrois.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==2){
                                        echo '<li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$pagePrecedente.'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$pageNexte.'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==$pagesAvantTotales){
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$pagePrecedente.'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$pageNexte.'">'.$pageNexte.'</a></li>';
                                    }else if($pageCourante==$pagesTotales){
                                            echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$pageAvantPrecedente.'">'.$pageAvantPrecedente.'</a></li><li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$pagePrecedente.'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li>';
                                    }else{
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$pagePrecedente.'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$pageNexte.'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>'; 
                                    }
                                }else{
                                    for ($i=1; $i <= $pagesTotales ; $i++) { 
                                        if ($i==$pageCourante) {
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="table_rectifier_model.php?page='.$i.'">'.$i.'</a></li>';
                                        }
                                    } 
                                }
  ...
  $(function() {
                ...
                $.ajax({
                        ...
                        success:function(ret){
                            if(ret==1){
                                ...
                                window.location.replace('table_rectifier_model.php');
                            }else if(ret==2){
    ...
    $('#enregistrermod').click(function(){
        if($('#Design_mod').val()==''){
                ...
                $.ajax({
                        url:'edit_rectifier_model.php',
                        type:'post',
                        beforeSend:function(){
                        },
                        dataType:'text',
                        data: {Design:$('#Design_mod').val(), token:$('#tok').val(), ID:$('#ID_Rectifier_Model').val()},
                        success:function(ret){
                            if(ret==1){
                                alertify.success("L'opération a réussi");
                                Toast.fire({
