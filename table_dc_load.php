<?php
    ...
    $query="SELECT * FROM table_dc_load ORDER BY Design_Dc";
    $req=$pdo->query($query);
    $Total=$req->rowCount();
    $totalparpage=10;
...
<html lang="fr-FR">
  <head>
    ...
    <title>DC Load | <?php echo $app_infos['Design_App']; ?></title>
    <!-- CSS files -->
    <!-- DataTables CSS -->
...
<?php } ?>
    ...
    <?php while($selections=$selection->fetch()){$Nbr++; ?>
        <tr class="odd gradeX" style="background: transparent;">
            ...
            <td><!-- <center> --><?php echo strtoupper(stripslashes($selections['Design_Dc'])); ?></td>
            <td><center><?php if ($selections['Active']==1){echo 'Default';}else{ echo '<a class="btn btn-success" style="width:30px; margin-right: 5px; border-radius: 0;" href="activer_dc_load.php?ID='.$selections['ID_Dc'].'&token='.$_SESSION['user_eteelo_app']['token'].'" title="Set as default" style="margin-right: 5px"><i class="fa fa-check fa-fw"></i></a>';} ?></center></td>
            <td style="padding-left: 250px"><!-- <center> -->
                <a href="#" onclick="Function_Modifier(<?php echo($selections['ID_Dc']); ?>, '<?php echo (stripslashes($selections['Design_Dc'])); ?>')" title="Modifier" style="margin-right: 5px; width: 25px; border-radius: 0;" class="btn btn-primary"><i class="fa fa-edit fa-fw"></i></a>
                <?php if($selections['Active']!=1){ ?>
                <a style="width: 25px; border-radius: 0;" class="btn btn-danger" href="javascript: alertify.confirm('Voulez-vous vraiment supprimer cette désignation ?\n Toutes les informations concernant cette désignation seront supprimées!').set('onok',function(closeEvent){window.location.replace('suppr_dcload.php?ID=<?php echo($selections['ID_Dc']) ?>&token=<?php echo($_SESSION['user_eteelo_app']['token']) ?>');alertify.success('suppression éffectuée');}).set('oncancel',function(closeEvent){alertify.error('suppression annulée');}).set({title:''},{labels:{ok:'Oui', cancel:'Annuler'}});" title="Supprimer"><i class="fa fa-trash-o fa-fw"></i></a><!-- </center>-->
                <?php } ?>
            </td>
        </tr>
    <?php } ?>
              ...
              <ul class="pagination ms-auto">
                                ...
                                if($pagesTotales>3){
                                    ...
                                    if($pageCourante==1){
                                        echo '<li class="page-item"><a class="page-link" href="#">1</a></li><li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$pageNexte.'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$pageTrois.'">'.$pageTrois.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==2){
                                        echo '<li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$pagePrecedente.'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$pageNexte.'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==$pagesAvantTotales){
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$pagePrecedente.'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$pageNexte.'">'.$pageNexte.'</a></li>';
                                    }else if($pageCourante==$pagesTotales){
                                            echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$pageAvantPrecedente.'">'.$pageAvantPrecedente.'</a></li><li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$pagePrecedente.'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li>';
                                    }else{
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$pagePrecedente.'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$pageNexte.'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>'; 
                                    }
                                }else{
                                    for ($i=1; $i <= $pagesTotales ; $i++) { 
                                        if ($i==$pageCourante) {
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="table_dc_load.php?page='.$i.'">'.$i.'</a></li>';
                                        }
                                    } 
                                }
        ...
        <div class="modal-dialog modal-sm" style="border: 1px solid #E6E7E9">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Ajout DC Load</h4>
    ...
    <div id="ModalModif" class="modal fade" data-backdrop="static" style="margin-top: 100px">
        <div class="modal-dialog modal-sm" style="border: 1px solid #E6E7E9">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Modification DC Load</h4>
  ...
  $(function() {
                ...
                $.ajax({
                        ...
                        success:function(ret){
                            if(ret==1){
                                ...
                                window.location.replace('table_dc_load.php');
                            }else if(ret==2){
    ...
    $('#enregistrermod').click(function(){
        if($('#Design_mod').val()==''){
                ...
                $.ajax({
                        url:'edit_dc_load.php',
                        type:'post',
                        beforeSend:function(){
                        },
                        dataType:'text',
                        data: {Design:$('#Design_mod').val(), token:$('#tok').val(), ID:$('#ID_Dc').val()},
                        success:function(ret){
                            if(ret==1){
                                alertify.success("L'opération a réussi");
                                Toast.fire({
