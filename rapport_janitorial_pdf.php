...
$pdf->SetSubject(utf8_decode($app_infos['Design_App']." : JANITORIALS, FACILITIES AND ALARMS LIST"));
$pdf->SetTitle(utf8_decode($app_infos['Design_App']." : JANITORIALS, FACILITIES AND ALARMS LIST"));
...
$pdf->Cell(290,10,utf8_decode("JANITORIALS, FACILITIES AND ALARMS LIST"),0,0,'C');
$pdf->Ln(20);
...
while($selections=$selection->fetch()){
    ...
    $pdf->Cell(50 ,6,utf8_decode(strtoupper(stripslashes($selections['Num_Work_Order']))),1,0,'L');
    ...
    $pdf->Cell(30 ,6,utf8_decode(strtoupper(stripslashes($selections['Design_Type']))),1,0,'C');
	$pdf->Ln();
}
$pdf->Output();
?>