    ...
    <?php } ?>
              ...
              <ul class="pagination ms-auto">
                                ...
                                if($pagesTotales>3){
                                    ...
                                    if($pageCourante==1){
                                        echo '<li class="page-item"><a class="page-link" href="#">1</a></li><li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$pageNexte.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$pageTrois.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$pageTrois.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==2){
                                        echo '<li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$pagePrecedente.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$pageNexte.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==$pagesAvantTotales){
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$pagePrecedente.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$pageNexte.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$pageNexte.'</a></li>';
                                    }else if($pageCourante==$pagesTotales){
                                            echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$pageAvantPrecedente.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$pageAvantPrecedente.'</a></li><li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$pagePrecedente.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li>';
                                    }else{
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$pagePrecedente.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$pageNexte.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>'; 
                                    }
                                }else{
                                    for ($i=1; $i <= $pagesTotales ; $i++) { 
                                        if ($i==$pageCourante) {
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="table_inscription_today.php?page='.$i.'&Ecole='.$_GET['Ecole'].'&Annee='.$_GET['Annee'].'&Classe='.$_GET['Classe'].'&Eleve='.$_GET['Eleve'].'">'.$i.'</a></li>';
                                        }
                                    } 
                                }
                ...
                $.ajax({
                        ...
                        success:function(ret){
                            if(ret==1){
                                ...
                                window.location.replace('table_inscription_today.php?Ecole='+$('#ID_Etab').val()+"&Enseignant="+$('#Enseignant').val());
                            }else if(ret==2){
