...
$pdf->SetSubject(utf8_decode($app_infos['Design_App']." : RECTIFIER AND STORAGE BATTERY MAINTENANCE LIST"));
$pdf->SetTitle(utf8_decode($app_infos['Design_App']." : RECTIFIER AND STORAGE BATTERY MAINTENANCE LIST"));
...
$pdf->Cell(290,10,utf8_decode("RECTIFIER AND STORAGE BATTERY MAINTENANCE LIST"),0,0,'C');
$pdf->Ln(20);
...
$pdf->Cell(30 ,6,utf8_decode("Rectifier make"),1,0,'C');
$pdf->Cell(31 ,6,utf8_decode("Rectifier model"),1,0,'C');
$pdf->Cell(30 ,6,utf8_decode("Work Order No"),1,0,'C');
$pdf->Cell(27 ,6,utf8_decode("Date"),1,0,'C');
$pdf->Cell(27 ,6,utf8_decode("Time In"),1,0,'C');
$pdf->Cell(27 ,6,utf8_decode("Time Out"),1,0,'C');
...
while($selections=$selection->fetch()){
    ...
    $pdf->Cell(30 ,6,utf8_decode(strtoupper(stripslashes($selections['Design_Rectifier_Make']))),1,0,'L');
    $pdf->Cell(31 ,6,utf8_decode(strtoupper(stripslashes($selections['Design_Rectifier_Model']))),1,0,'L');
    $pdf->Cell(30 ,6,utf8_decode(strtoupper(stripslashes($selections['Num_Work_Order']))),1,0,'L');
    $pdf->Cell(27 ,6,date('d/m/Y', strtotime($selections['Date_Rapport'])),1,0,'C');
    $pdf->Cell(27 ,6,date('H:i', strtotime($selections['Time_In'])),1,0,'C');
    $pdf->Cell(27 ,6,date('H:i', strtotime($selections['Time_Out'])),1,0,'C');
	$pdf->Ln();
}
$pdf->Output();
?>