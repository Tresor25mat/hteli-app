...
$req_rapport = $pdo->query("SELECT * FROM table_rapport_journalier_new INNER JOIN site ON table_rapport_journalier_new.ID_Site=site.ID_Site INNER JOIN province ON site.ID_Prov=province.ID_Prov WHERE table_rapport_journalier_new.ID_Rapport=" . $ID_Rapport);
$rapports = $req_rapport->fetch();
$fme = $pdo->query("SELECT * FROM agent WHERE ID_Agent=" . $rapports['ID_Agent']);
$fmes = $fme->fetch();
$titre = $pdo->query("SELECT * FROM table_titre_rapport_new INNER JOIN table_sous_titre_new ON table_titre_rapport_new.ID_Sous_Titre=table_sous_titre_new.ID_Sous_Titre WHERE table_titre_rapport_new.ID_Rapport=" . $rapports['ID_Rapport']);
$nombre_titre = $pdo->query("SELECT COUNT(*) AS Nbr FROM table_titre_rapport_new INNER JOIN table_sous_titre_new ON table_titre_rapport_new.ID_Sous_Titre=table_sous_titre_new.ID_Sous_Titre WHERE table_titre_rapport_new.ID_Rapport=" . $rapports['ID_Rapport']);
...
while ($titres = $titre->fetch()) {
    ...
    $photo = $pdo->query("SELECT * FROM table_photo_rapport_new WHERE ID_Titre_Rapport=" . $titres['ID_Titre_Rapport']);
    $Nombre_Photo = $pdo->query("SELECT COUNT(*) AS Nbr FROM table_photo_rapport_new WHERE ID_Titre_Rapport=" . $titres['ID_Titre_Rapport']);
