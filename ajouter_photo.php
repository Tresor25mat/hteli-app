...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="overflow-x: hidden; background-color: white">
    <div class="page">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="tab-content">
                      <div class="tab-pane" id="tabs-home-12">
                                    ...
                                    <div class="row">
                                      <div class="col-md-3" style="margin-bottom: 5px;">
                                        <div class="form-group ">
                                          <label for="province" class="control-label col-lg-12" style="text-align: left;">Procince *</label>
                                          <div class="col-lg-12">
                                      ...
                                      <div class="col-md-3" style="margin-bottom: 5px;">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <select name="dc_load" id="dc_load" class="form-control ">
                                              <option value="">--</option>
                                              <?php while($table_dc_load=$table_dc->fetch()){ ?>
                                              <option value="<?php echo($table_dc_load['ID_Dc'])?>" <?php if($table_dc_load['ID_Dc']==$rapports['ID_Dc']){echo 'selected';} ?>><?php echo strtoupper($table_dc_load['Design_Dc']); ?></option>
                                              <?php } ?>
                                            </select>
                                          </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12" style="text-align: center; border-top: 1px solid #E6E7E9; padding-top: 10px; margin-top: 10px">
                                            ...
                                            <?php while($Nombre<=$table_stitres['Nombre_Photo']){$Nombre++; $Nombre_Total++; 
                                                $photo=$pdo->query("SELECT * FROM table_photo_rapport INNER JOIN table_titre_rapport ON table_titre_rapport.ID_Titre_Rapport=table_photo_rapport.ID_Titre_Rapport WHERE table_titre_rapport.ID_Rapport=".$rapports['ID_Rapport']." AND table_titre_rapport.ID_Sous_Titre=".$table_stitres['ID_Sous_Titre']." AND table_photo_rapport.Indice_Photo=".$Nombre_Total);
                                                ?>
                                                <div class="col-sm-4" style="border-top: 1px solid #E6E7E9; padding-top: 10px; margin-top: 10px; margin-bottom: 5px">
                                                  <form class="PicturesForm" id="PicturesForm_<?php echo $Nombre_Total; ?>" method="post" action="" enctype="multipart/form-data">
                                                    ...
                                                    <div style="border: 2px solid RGB(234,234,234); height: 200px">
                                                        ...
                                                        <img src="<?php if($photos=$photo->fetch()){echo 'images/rapports/'.$photos['Photo'];}else{echo 'images/picture.png';} ?>" style="height: 180px; margin-top: 10px" id="miamge_<?php echo $Nombre_Total; ?>" class="miamge">
                                                        </a>
                                                    </div>
    ...
    $('.PicturesForm').submit(function(e){
        ...
        $('#btn_enregistrer').click(function(){
            window.location.replace('afficher_image.php?ID='+$('#ID_Rapport').val()+'&Titre='+$('#Titre').val());
          })
  })
