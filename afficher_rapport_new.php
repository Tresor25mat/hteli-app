...
$titre = $pdo->query("SELECT * FROM table_titre_new ORDER BY Code_Titre");
...
<div class="page">
          ...
          <div class="container-xl">
            ...
            <div class="col-md-4" style="border: 1px solid #E6E7E9; padding: 10px">
                  ...
                  <div class="card-body">
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                      ...
                      <?php while ($titres = $titre->fetch()) {
                          $sous_titre = $pdo->query("SELECT * FROM table_sous_titre_new WHERE ID_Titre=" . $titres['ID_Titre'] . " ORDER BY Code_Sous_Titre");
              ...
              <div class="col-md-8" style="border: 1px solid #E6E7E9; padding: 10px">
                <div class="card">
                  <div class="card-body">
                  <iframe src="afficher_image_new.php?ID=<?php echo $ID; ?>" style="width: 100%; height: 800px; border: none; background-color: #FFFFFF" id="iframe"></iframe>
                  </div>
                </div>
              </div>
            </div>
    ...
    function afficher_image(a, b){
        $('#iframe').attr('src', 'afficher_image_new.php?ID='+b+'&Titre='+a);
    }
    </script>
</body>