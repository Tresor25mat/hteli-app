...
<!--             <div class="d-none d-md-flex">
              <a href="?theme=dark" class="nav-link px-0 hide-theme-dark" title="Enable dark mode" data-bs-toggle="tooltip" data-bs-placement="bottom" style="margin-right: 20px">
                Download SVG icon from http://tabler-icons.io/i/moon
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z" /></svg>
              </a>
              <a href="?theme=light" class="nav-link px-0 hide-theme-light" title="Enable light mode" data-bs-toggle="tooltip" data-bs-placement="bottom" style="border: 1px solid #D9DBDE; margin-right: 20px">
                Download SVG icon from http://tabler-icons.io/i/sun
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><circle cx="12" cy="12" r="4" /><path d="M3 12h1m8 -9v1m8 8h1m-9 8v1m-6.4 -15.4l.7 .7m12.1 -.7l-.7 .7m0 11.4l.7 .7m-12.1 -.7l-.7 .7" /></svg>
              </a>
            </div> -->
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu" title="<?php echo ($_SESSION['user_eteelo_app']['Prenom'].' '.$_SESSION['user_eteelo_app']['Nom']).' '; ?>">
                <span class="avatar avatar-sm" id="miamge" style="background-image: url(<?php echo($Photo); ?>)"><img src="images/connecte.gif" class="img-circle" style="width: 11px; height: 11px; margin-top: 34px; margin-left: 40px; margin-bottom: 10px; margin-right: 12px;"></span>
                <div class="d-none d-xl-block ps-2">
                  <div><?php echo ($_SESSION['user_eteelo_app']['Prenom'].' '.$_SESSION['user_eteelo_app']['Nom']); ?></div>
                  <div class="mt-1 small text-muted"><?php echo ($_SESSION['user_eteelo_app']['Statut']); ?></div>
                </div>
              </a>
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                <?php if($theme=="light"){ ?>
                <a href="?theme=dark" class="dropdown-item" id="mode_nuit">Mode Nuit</a>
                <?php }else{ ?>
                <a href="?theme=light" class="dropdown-item" id="mode_lumiere">Mode Lumière</a>
                <?php } ?>
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item gonow" ver="profile.php">Profile</a>
      ...
      <div class="navbar-expand-md" id="top">
        <div class="collapse navbar-collapse" id="navbar-menu">
          <div class="navbar navbar-light">
            <div class="container-xl">
              <ul class="navbar-nav">
                <li class="nav-item active">
                  <a class="nav-link gonow" ver="accueil.php" href="#">
            ...
            <!-- <div class="row g-2 align-items-center"> -->
              <!-- <div class="col"> -->
                ...
                <!-- <div class="page-pretitle"> -->
                  <iframe src='accueil.php' style="width: 100%; height: 2000px; border: none;" id="iframe"></iframe>
                <!-- </div> -->
...
<!--                   <li class="list-inline-item">
                      <?php echo $app_infos['Design_App']; ?>
                  </li> -->
                </ul>
              </div>
            </div>
          </div>
          <a class="top-link" id="bot" href="top#" style="display: inline;">Top</a>
        </footer>
      </div>
    </div>
    <!-- Libs JS -->
  ...
  <script type="text/javascript">
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        // if user scrolls down - show scroll to top button  && ($("#top").is(':visible'))
     
            if (topPos > 80) {
                $('#top').addClass("fixed-mat");
            } else {
                $('#top').removeClass("fixed-mat");
            }
        });
    ...
    $('.gonow').click(function(e){
        ...
        // }
        $('.dropdown-menu').click();
        $('.gonow').removeClass('active');
        $(this).addClass('active');
    });
        function changer_profil(){
            $.ajax({
                url:'recherche_photo.php',
                type:'post',
                dataType:'text',
                data: {Utilisateur:<?php echo ($_SESSION['user_eteelo_app']['ID_Utilisateur']); ?>},
                success:function(ret){
                    if(ret==1){
                        mphoto="images/photo_femme.jpg";
                    }else if(ret==2){
            ...
            $.ajax({
                ...
                success:function(ret){
                    if(ret!=0){
                          ...
                          var unique_id = $.gritter.add({
                            // (string | mandatory) the heading of the notification
                            title: 'Bienvenu(e) '+ valeur[0]+' '+valeur[1]+'!',
                            // (string | mandatory) the text inside the notification
                            text: "Cet utilisateur vient de se connecter",
                            // (string | optional) the image to display on the left
                            image: valeur[2],
                            // (bool | optional) if you want it to fade out on its own or just sit there
                            sticky: false,
