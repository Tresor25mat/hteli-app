...
<html lang="fr-FR">
  <head>
    ...
    <title>Situation de paiement par classe | <?php echo $app_infos['Design_App']; ?></title>
    <!-- CSS files -->
    <!-- DataTables CSS -->
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="overflow-x: hidden;">
    ...
    $('#btn_afficher').click(function(){
        if($('#classe').val()!='' && $('#annee').val()!=''){
            $('#iframe').attr('src', "situation_par_classe_pdf.php?classe="+$('#classe').val()+'&annee='+$('#annee').val()+'&frais='+$('#frais').val()+'&ecole='+$('#ecole').val());
        }else{
            alertify.alert('<?php echo $app_infos['Design_App']; ?>', "Veuillez selectionner la classe et l'année scolaire svp!");
            $('#classe').focus();
        }
    })
    ...
    $('#btn_exporter').click(function(){
        if($('#classe').val()!='' && $('#annee').val()!=''){
            $('#iframe').attr('src', "situation_par_classe_excel.php?classe="+$('#classe').val()+'&annee='+$('#annee').val()+'&frais='+$('#frais').val()+'&ecole='+$('#ecole').val());
        }else{
            alertify.alert('<?php echo $app_infos['Design_App']; ?>', "Veuillez selectionner la classe et l'année scolaire svp!");
            $('#classe').focus();
        }
