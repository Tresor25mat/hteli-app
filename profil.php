<?php
    ...
    if(empty($_SESSION['logged_siges']) || $_SESSION['logged_siges']==false){
        header("location: connexion");
    }
    require_once ("connexion.php");
    $ID = $_SESSION['user_siges']['ID_Utilisateur'];
    $Utilisateur = $pdo->query('SELECT * FROM utilisateur WHERE ID_Utilisateur='.$ID);
    $Utilisateurs = $Utilisateur->fetch();
    $agence=$pdo->query("SELECT * FROM table_agence WHERE ID_Agence=".$Utilisateurs['ID_Agence']);
            ...
            <div class="row row-deck row-cards">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card">
                  ...
                  <input id="token" type="hidden" name="token" value="<?php echo($_SESSION['user_siges']['token']); ?>">
                  <input class="form-control" id="mimg" type="file" name="mimg" style="display: none;" accept=".jpg, .jpeg, .png">
                    ...
                    <?php if($Utilisateurs['Statut']!='Admin' && $Utilisateurs['Statut']!='User_IT'){ ?>
                    <div class="mt-3">
                      <span class="badge bg-purple-lt">Point de vente: <?php echo ($agences['Design_Agence']); ?></span>
                    </div>
                    <?php } ?>
                    <div class="mt-3">
                  ...
                  <div class="d-flex">
                    ...
                    <a href="tel:<?php echo $Utilisateurs['Tel']; ?>" class="card-btn"><!-- Download SVG icon from http://tabler-icons.io/i/phone -->
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2 text-muted" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" /></svg>
                      <?php echo $Utilisateurs['Tel']; ?></a>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <form method="post" action="">
                    <input id="tok" type="hidden" name="tok" value="<?php echo($_SESSION['user_siges']['token']); ?>">
