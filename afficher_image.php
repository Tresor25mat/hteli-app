<?php
    ...
    $selection=$pdo->query("SELECT * FROM table_photo_rapport INNER JOIN table_titre_rapport ON table_titre_rapport.ID_Titre_Rapport=table_photo_rapport.ID_Titre_Rapport WHERE table_titre_rapport.ID_Rapport=".$ID." AND table_titre_rapport.ID_Sous_Titre=".$table_stitres['ID_Sous_Titre']);
                         ...
                         <div class="row" style="margin-top: 10px; padding-bottom: 10px">
                                            <div class="col-lg-12">
                                              <div class="pull-right">
                                                  <a href="ajouter_photo.php?ID=<?php echo $ID; ?>&Titre=<?php if(isset($_GET['Titre']) && $_GET['Titre']!=''){echo $_GET['Titre']; } ?>" class="btn btn-default" title="Ajouter des photos">Ajouter des photos</a>
