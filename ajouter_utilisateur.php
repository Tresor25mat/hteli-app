                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-lg-10">
                                            <select name="profil" id="profil" class="form-control ">
                                              ...
                                              <?php while ($profils=$profil->fetch()) { ?>
                                                <option value="<?php echo $profils['ID_Profil']; ?>"><?php echo stripslashes($profils['Design_Profil']); ?></option>
                                              <?php } ?>
                                            </select>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control " id="tel" type="text" name="tel" placeholder="EX:24381xxxxxxx">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-4">
                                        ...
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <select name="statut" id="statut" class="form-control ">
                                              ...
                                              <option value="<?php echo ($statuts['Design_Statut']); ?>"><?php echo ($statuts['Design_Statut']); ?></option>
                                              <?php } ?>
                                            </select>
                                          </div>
                                        </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <select name="agence" id="agence" class="form-control " disabled="disabled">
                                              <option value="">--</option>
                                              <?php while($agences=$agence->fetch()){ ?>
                                              <option value="<?php echo($agences['ID_Agence']); ?>"><?php echo stripslashes($agences['Design_Agence']); ?></option>
                                              <?php } ?>
                                            </select>
                                          </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="images" style="border: 1px solid RGB(238,238,238); padding-left: 30px; padding-top: 10px; padding-right: 30px">
                                    ...
                                    <div class="form-group ">
                                      ...
                                      <div class="col-lg-10">
                                        ...
                                        <img src="images/photo.jpg" style="width: 150px; height: 150px; border: 2px solid RGB(234,234,234); border-radius: 0" id="miamge" class="miamge">
                                        </a>
                                      </div>
                                    </div>
                                    </div>
...
$(document).ready(function(){
    ...
    $('#btn_next').click(function(){
        if($('#prenom').val()=='' || $('#nom').val()=='' || $('#profil').val()=='' || $('#login').val()=='' || $('#password').val()=='' || $('#tel').val()==''){
