...
$query = "SELECT * FROM table_project ORDER BY Design_Project";
$req = $pdo->query($query);
$Total = $req->rowCount();
$totalparpage = 10;
...
<head>
    ...
    <title>Projects | <?php echo $app_infos['Design_App']; ?></title>
    <!-- CSS files -->
    <!-- DataTables CSS -->
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                      ...
                      New view
                                ...
                                <a href="#" id="btn_ajouter" class="btn btn-primary d-sm-inline-block" title="Ajouter">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round" style="font-weight: bold;">
                            ...
                            <tbody id="MaTable">
                                <?php while ($selections = $selection->fetch()) {
                                    ...
                                    <tr class="odd gradeX" style="background: transparent;">
                                        ...
                                        <td><!-- <center> --><?php echo strtoupper(stripslashes($selections['Design_Project'])); ?>
                                        </td>
                                        <td style="text-align: center"><!-- <center> --><?php echo $selections['Nombre_Photo']; ?>
                                        </td>
                                        <td style="padding-left: 250px"><!-- <center> -->
                                            <a href="#"
                                                onclick="Function_Modifier(<?php echo ($selections['ID_Project']); ?>, '<?php echo (stripslashes($selections['Design_Project'])); ?>', <?php echo $selections['Nombre_Photo']; ?>)"
                                                title="Modifier" style="margin-right: 5px; width: 25px; border-radius: 0;"
                                            ...
                                            <?php if ($_SESSION['user_eteelo_app']['ID_Statut'] == 1) { ?>
                                                <a style="width: 25px; border-radius: 0;" class="btn btn-danger"
                                                    href="javascript: alertify.confirm('Voulez-vous vraiment supprimer cette désignation ?\n Toutes les informations concernant cette désignation seront supprimées!').set('onok',function(closeEvent){window.location.replace('suppr_project.php?ID=<?php echo ($selections['ID_Project']) ?>&token=<?php echo ($_SESSION['user_eteelo_app']['token']) ?>');alertify.success('suppression éffectuée');}).set('oncancel',function(closeEvent){alertify.error('suppression annulée');}).set({title:''},{labels:{ok:'Oui', cancel:'Annuler'}});"
                                                    title="Supprimer"><i class="fa fa-trash-o fa-fw"></i></a><!-- </center>-->
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                        ...
                        <div class="d-flex mt-4">
                            <ul class="pagination ms-auto">
                                ...
                                if ($pagesTotales > 3) {
                                    ...
                                    if ($pageCourante == 1) {
                                        echo '<li class="page-item"><a class="page-link" href="#">1</a></li><li class="page-item"><a class="page-link" href="table_project.php?page=' . $pageNexte . '">' . $pageNexte . '</a></li><li class="page-item"><a class="page-link" href="table_project.php?page=' . $pageTrois . '">' . $pageTrois . '</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    } else if ($pageCourante == 2) {
                                        echo '<li class="page-item"><a class="page-link" href="table_project.php?page=' . $pagePrecedente . '">' . $pagePrecedente . '</a></li><li class="page-item active"><a class="page-link" href="#">' . $pageCourante . '</a></li><li class="page-item"><a class="page-link" href="table_project.php?page=' . $pageNexte . '">' . $pageNexte . '</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    } else if ($pageCourante == $pagesAvantTotales) {
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_project.php?page=' . $pagePrecedente . '">' . $pagePrecedente . '</a></li><li class="page-item active"><a class="page-link" href="#">' . $pageCourante . '</a></li><li class="page-item"><a class="page-link" href="table_project.php?page=' . $pageNexte . '">' . $pageNexte . '</a></li>';
                                    } else if ($pageCourante == $pagesTotales) {
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_project.php?page=' . $pageAvantPrecedente . '">' . $pageAvantPrecedente . '</a></li><li class="page-item"><a class="page-link" href="table_project.php?page=' . $pagePrecedente . '">' . $pagePrecedente . '</a></li><li class="page-item active"><a class="page-link" href="#">' . $pageCourante . '</a></li>';
                                    } else {
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_project.php?page=' . $pagePrecedente . '">' . $pagePrecedente . '</a></li><li class="page-item active"><a class="page-link" href="#">' . $pageCourante . '</a></li><li class="page-item"><a class="page-link" href="table_project.php?page=' . $pageNexte . '">' . $pageNexte . '</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }
                                } else {
                                    for ($i = 1; $i <= $pagesTotales; $i++) {
                                        if ($i == $pageCourante) {
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="table_project.php?page=' . $i . '">' . $i . '</a></li>';
                                        }
                                    }
                                }
        ...
        <div class="modal-dialog modal-sm" style="border: 1px solid #E6E7E9">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Ajout Project</h4>
                    <!-- <button type="button" class="close" datadismiss="modal" ariahidden="true" onclick="fermerDialogueEcole()">&times;</button> -->
                </div>
                <div class="modal-body">
                    <form method="post" action="">
                        <input id="tok" type="hidden" name="tok"
                            value="<?php echo ($_SESSION['user_eteelo_app']['token']); ?>">
                        <div class="col-lg-12">Désignation *</div>
                        <div class="col-lg-12"><input type="text" name="Design" id="Design" class="form-control"
                                style="margin-top: 1%;" value="" required></div>
                        <div class="col-lg-12">Nombre des photos *</div>
                        <div class="col-lg-12"><input type="number" name="nbre_photo" id="nbre_photo" class="form-control"
                                style="margin-top: 1%;" value="" required min="1"></div>
                    </form>
                </div>
    ...
    <div id="ModalModif" class="modal fade" data-backdrop="static" style="margin-top: 100px">
        <div class="modal-dialog modal-sm" style="border: 1px solid #E6E7E9">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Modification Project</h4>
                ...
                <div class="modal-body">
                    <form method="post" action="">
                        <input id="tok" type="hidden" name="tok"
                            value="<?php echo ($_SESSION['user_eteelo_app']['token']); ?>">
                        <div class="col-lg-12">Désignation *</div>
                        <div class="col-lg-12"><input type="text" name="Design_mod" id="Design_mod" class="form-control"
                                style="margin-top: 1%;" value="" required></div>
                        <div class="col-lg-12">Nombre des photos *</div>
                        <div class="col-lg-12"><input type="number" name="nbre_photo_mod" id="nbre_photo_mod" class="form-control"
                                style="margin-top: 1%;" value="" required min="1"></div>
                    </form>
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        $(function () {
            ...
            $('#enregistrer').click(function () {
                if ($('#Design').val() == '' || $('#nbre_photo').val() == '') {
                    alertify.alert('<?php echo $app_infos['Design_App']; ?>', 'Veuillez remplir tous les champs obligatoires svp!');
                    $('#Design').focus();
                } else {
                    $.ajax({
                        url: 'enreg_project.php',
                        type: 'post',
                        beforeSend: function () {
                        },
                        dataType: 'text',
                        data: { Design: $('#Design').val(), Nombre: $('#nbre_photo').val(), token: $('#tok').val() },
                        success: function (ret) {
                            if (ret == 1) {
                                ...
                                window.location.replace('table_project.php');
                            } else if (ret == 2) {
            ...
            $('#enregistrermod').click(function () {
                if ($('#Design_mod').val() == '' || $('#nbre_photo_mod').val() == '') {
                    alertify.alert('<?php echo $app_infos['Design_App']; ?>', 'Veuillez remplir tous les champs obligatoires svp!');
                    $('#Design_mod').focus();
                } else {
                    $.ajax({
                        ...
                        dataType: 'text',
                        data: { Design: $('#Design_mod').val(), Nombre: $('#nbre_photo_mod').val(), token: $('#tok').val(), ID: $('#ID_Project').val() },
                        success: function (ret) {
                            if (ret == 1) {
                                alertify.success("L'opération a réussi");
                                Toast.fire({
