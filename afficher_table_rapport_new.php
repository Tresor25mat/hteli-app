...
<html lang="fr-FR">
  <head>
    ...
    <title>Daily PM - Progress | <?php echo $app_infos['Design_App']; ?></title>
    <!-- CSS files -->
    <!-- DataTables CSS -->
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="overflow-x: hidden;">
            ...
            <div class="row g-2 align-items-center">
              ...
              <div class="col-12">
                <div class="row" style="border-bottom: 1px solid #EEEEEE; padding-bottom: 20px">
                    <div class="col-md-2" style="<?php if ($_SESSION['user_eteelo_app']['ID_Statut'] == 3) {
                        echo 'display: none';
                    } ?>">
                      <div class="form-group ">
                        ...
                        <div class="col-lg-12">
                          <div class="row">
                            <div class="col-sm-12">
                                <select name="utilisateur" class="form-control" id="utilisateur" <?php if ($_SESSION['user_eteelo_app']['ID_Statut'] == 3) {
                                    echo 'disabled';
                                } ?>>
                                    <option value="">--</option>
                                    <?php while ($utilisateurs = $utilisateur->fetch()) { ?>
                                        <option value="<?php echo ($utilisateurs['ID_Utilisateur']) ?>" <?php if ($_SESSION['user_eteelo_app']['ID_Statut'] == 3 && $utilisateurs['ID_Utilisateur'] == $_SESSION['user_eteelo_app']['ID_Utilisateur']) {
                                              echo 'selected';
                                          } else if (isset($_GET['User']) && $_GET['User'] != '' && $utilisateurs['ID_Utilisateur'] == $_GET['User']) {
                                              echo 'selected';
                                          } ?>><?php echo (stripslashes($utilisateurs['Prenom'] . ' ' . $utilisateurs['Nom'])) ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                          </div>
                    ...
                    <div class="col-md-<?php if ($_SESSION['user_eteelo_app']['ID_Statut'] == 3) {
                        echo '2';
                    } else {
                        echo '1';
                    } ?>">
                      <div class="form-group ">
                        ...
                        <div class="col-lg-12">
                          <div class="row">
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="siteId" id="siteId" value="<?php if (isset($_GET['siteId']) && $_GET['siteId'] != '') {
                                    echo $_GET['siteId'];
                                } ?>">
                            </div>
                          </div>
                    ...
                    <div class="col-md-<?php if ($_SESSION['user_eteelo_app']['ID_Statut'] == 3) {
                      ...
                      <div class="form-group ">
                        <label for="nocTicket" class="control-label col-lg-12" style="text-align: left;">Noc Ticket </label>
                        <div class="col-lg-12">
                          <div class="row">
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="nocTicket" id="nocTicket" value="<?php if (isset($_GET['nocTicket']) && $_GET['nocTicket'] != '') {
                                    echo $_GET['nocTicket'];
                                } ?>">
                            </div>
                          </div>
                    ...
                    <div class="col-md-2">
                      <div class="form-group ">
                        ...
                        <div class="col-lg-12">
                          <div class="row">
                            <div class="col-sm-12">
                                <input type="text" class="form-control date" name="dateRapport" id="dateRapport" value="<?php if (isset($_GET['dateRapport']) && $_GET['dateRapport'] != '') {
    ...
    $(document).ready(function() {
        ...
        $('#iframe').attr('src', "table_rapport_new.php?User="+$('#utilisateur').val()+'&siteId='+$('#siteId').val()+'&nocTicket='+$('#nocTicket').val()+'&dateRapport='+dateRap);
    });
  ...
  $(function() {
    ...
    $('#btn_ajouter').click(function(e){
      ...
      let dateRapport = $('#dateRapport').val();
      dateRap = dateRapport.replace(/\//g, "-");
      window.location.replace('ajouter_rapport_journalier_new.php?User='+$('#utilisateur').val()+'&siteId='+$('#siteId').val()+'&nocTicket='+$('#nocTicket').val()+'&dateRapport='+dateRap);
    })
