...
$sheet->setCellValue('A3', "QUALITY REPORTING STANDARDS LIST");
...
$sheet->SetCellValue('A7', "N°")->SetCellValue('B7', "Site ID & Name")->SetCellValue('C7', "Province")->SetCellValue('D7', "Project Reference")->SetCellValue('E7', "Field Eng. Name")->SetCellValue('F7', "Date");
$cell_st = [
...
$sheet->setTitle("QUALITY REPORTING STANDARDS"); //set a title for Worksheet
...
header('Content-Disposition: attachment;filename="Quality_Reporting_Standards_List_' . date('d') . '_' . date('m') . '_' . date('Y') . '_' . date('H') . '_' . date('i') . '_' . date('s') . '.xlsx"');
