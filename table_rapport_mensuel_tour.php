<?php
    ...
    if(isset($_GET['TowerType']) && $_GET['TowerType']!=''){
        $query.=" AND table_rapport_mensuel_tour.ID_Tower_Type=".$_GET['TowerType'];
    }
...
<?php } ?>
    ...
    <?php while($selections=$selection->fetch()){$Nbr++; ?>
        <tr class="odd gradeX" style="background: transparent;">
            ...
            <td><!-- <center> --><?php echo strtoupper(stripslashes($selections['Design_Tower_Type'])); ?></td>
    ...
    <?php } ?>
              ...
              <ul class="pagination ms-auto">
                                ...
                                if($pageCourante>1){
                                    $page=$pageCourante-1;
                                    echo '<li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$page.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="15 6 9 12 15 18" /></svg>Previous</a></li>';
                                }else{
                                ...
                                if($pagesTotales>3){
                                    ...
                                    if($pageCourante==1){
                                        echo '<li class="page-item"><a class="page-link" href="#">1</a></li><li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$pageNexte.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$pageTrois.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageTrois.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==2){
                                        echo '<li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$pagePrecedente.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$pageNexte.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>';
                                    }else if($pageCourante==$pagesAvantTotales){
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$pagePrecedente.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$pageNexte.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageNexte.'</a></li>';
                                    }else if($pageCourante==$pagesTotales){
                                            echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$pageAvantPrecedente.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageAvantPrecedente.'</a></li><li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$pagePrecedente.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li>';
                                    }else{
                                        echo '<li class="page-item"><a class="page-link" href="#">...</a></li><li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$pagePrecedente.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pagePrecedente.'</a></li><li class="page-item active"><a class="page-link" href="#">'.$pageCourante.'</a></li><li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$pageNexte.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$pageNexte.'</a></li><li class="page-item"><a class="page-link" href="#">...</a></li>'; 
                                    }
                                }else{
                                    for ($i=1; $i <= $pagesTotales ; $i++) { 
                                        if ($i==$pageCourante) {
                                            ...
                                            echo '<li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$i.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">'.$i.'</a></li>';
                                        }
                                    } 
                                }
                                if($pagesTotales>$pageCourante){
                                    $page=$pageCourante+1;
                                    echo '<li class="page-item"><a class="page-link" href="table_rapport_mensuel_tour.php?page='.$page.'&User='.$_GET['User'].'&siteId='.$_GET['siteId'].'&TowerType='.$_GET['TowerType'].'&dateRapport='.$_GET['dateRapport'].'">Next<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="9 6 15 12 9 18" /></svg></a></li>';
                                }else{
