           ...
           if ($err) {
            ...
            if($tel=$sel_tel->fetch()){
              ...
              // $insert=$pdo->query("INSERT INTO conversation (ID_Conversation, ID_Utilisateur) VALUES ('".$ID_Conversation."', ".$_SESSION['user_courrier']['ID_Utilisateur'].")");
                ...
                $insert_participer=$pdo->query("INSERT INTO participer (ID_Participer, ID_Conversation, ID_Telephone, Reponse, smsCount, Command, ID_Utilisateur, Statut) VALUES ('".$ID_Participer."', '".$ID_Conversation."', '".$tel['ID_Telephone']."', '".$response."',".$mystring.", 1, ".$utilisateurs['ID_Utilisateur'].",'".$statut."')");
            }else{
              ...
              $insert=$pdo->query("INSERT INTO conversation (ID_Conversation, Date_Envoie, ID_Utilisateur) VALUES ('".$ID_Conversation."', Now(), ".$utilisateurs['ID_Utilisateur'].")");
                ...
                $insert_participer=$pdo->query("INSERT INTO participer (ID_Participer, ID_Conversation, ID_Telephone, Reponse, smsCount, Command, ID_Utilisateur, Statut) VALUES ('".$ID_Participer."', '".$ID_Conversation."', '".$ID_Telephone."', '".$response."',".$mystring.", 1, ".$utilisateurs['ID_Utilisateur'].",'".$statut."')");
            }
