...
<html lang="fr-FR">
  <head>
    ...
    <title>Monthly Site Inspection | <?php echo $app_infos['Design_App']; ?></title>
    <!-- CSS files -->
    <!-- DataTables CSS -->
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="overflow-x: hidden;">
            ...
            <div class="row g-2 align-items-center">
              ...
              <div class="col-12">
                <div class="row" style="border-bottom: 1px solid #EEEEEE; padding-bottom: 20px">
                    ...
                    <div class="col-md-<?php if($_SESSION['user_eteelo_app']['ID_Statut']==3){ echo '2';}else{echo '1';} ?>">
                      <div class="form-group ">
                        <label for="numRef" class="control-label col-lg-12" style="text-align: left;">Ref. No </label>
                        <div class="col-lg-12">
                          <div class="row">
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="numRef" id="numRef" value="<?php if(isset($_GET['numRef']) && $_GET['numRef']!=''){echo $_GET['numRef']; } ?>">
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    $(document).ready(function() {
        ...
        $('#iframe').attr('src', "table_rapport_mensuel_site.php?User="+$('#utilisateur').val()+'&siteId='+$('#siteId').val()+'&numRef='+$('#numRef').val()+'&dateRapport='+dateRap);
    });
  ...
  $(function() {
    ...
    $('#btn_ajouter').click(function(e){
      ...
      let dateRapport = $('#dateRapport').val();
      dateRap = dateRapport.replace(/\//g, "-");
      window.location.replace('ajouter_rapport_mensuel_site.php?User='+$('#utilisateur').val()+'&siteId='+$('#siteId').val()+'&numRef='+$('#numRef').val()+'&dateRapport='+dateRap);
    })
