              ...
              <div class="col-12">
                <div class="row" style="border-bottom: 1px solid #EEEEEE">
                    <div class="col-md-3">
                      <div class="form-group ">
                        ...
                        <div class="col-lg-12">
                          <div class="row">
                            <div class="col-sm-12">
                                <select name="ecole" class="form-control" id="ecole">
                                    <option value="">--</option>
                                    <?php while($ecoles=$ecole->fetch()){ ?>
                                    <option value="<?php echo($ecoles['ID_Etablissement']) ?>"><?php echo(stripslashes($ecoles['Design_Etablissement'])) ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                          </div>
                    ...
                    <div class="col-12 col-md-auto ms-auto d-print-none">
                        <div class="btn-list">
                        <a href="#" id="ajouter_ecole" class="btn btn-primary d-sm-inline-block" title="Ajouter une section">
