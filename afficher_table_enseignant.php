...
<html lang="fr-FR">
  <head>
    ...
    <title>Enseignants | <?php echo $app_infos['Design_App']; ?></title>
    <!-- CSS files -->
    <!-- DataTables CSS -->
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="overflow-x: hidden;">
              ...
              <div class="col-12">
                <div class="row" style="border-bottom: 1px solid #EEEEEE; padding-bottom: 20px">
                    ...
                    <div class="col-md-3">
                      <div class="form-group ">
                        ...
                        <div class="col-lg-12">
                          <div class="row">
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="nom_ensignant" id="nom_ensignant">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-12 col-md-auto ms-auto d-print-none" style="margin-top: 18px">
                        <div class="btn-list">
                        <a href="#" id="btn_ajouter" class="btn btn-primary d-sm-inline-block" title="Ajouter un(e) enseignant(e)">
    ...
    $(document).ready(function() {
        $('#iframe').attr('src', "table_enseignant.php?Ecole="+$('#ecole').val()+'&Enseignant='+$('#nom_ensignant').val());
    });
  ...
  $(function() {
    ...
    $('#enregistrer').click(function(){
        if($('#nom_ens').val()=='' || $('#liste_ecole').val()=='' || $('#prenom_ens').val()=='' || $('#sexe').val()==''){
                ...
                $.ajax({
                        url:'enreg_enseignant.php',
                        type:'post',
                        beforeSend:function(){
                        },
                        dataType:'text',
                        data: {Nom:$('#nom_ens').val(), Pnom:$('#pnom_ens').val(), Prenom:$('#prenom_ens').val(), Sexe:$('#sexe').val(), Tel:$('#telephone').val(), Ecole:$('#liste_ecole').val(), token:$('#tok').val()},
                        success:function(ret){
                            if(ret==1){
                                ...
                                alertify.alert('<?php echo $app_infos['Design_App']; ?>', 'Cette enseignant existe déjà'); 
                            }else{
