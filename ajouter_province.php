                                          ...
                                          <div class="col-lg-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <?php while ($pays = $pay->fetch()) { ?>
                                                        <option value="<?php echo ($pays['ID_Pays']); ?>" <?php if($pays['ID_Pays']==$_SESSION['user_eteelo_app']['ID_Pays'] && $_SESSION['user_eteelo_app']['ID_Statut']!=1){echo 'selected'; } ?>><?php echo ($pays['Design_Pays']); ?></option>
                                                    <?php } ?>
                                                </select>
      ...
      timer: 5000
        ...
        $('#btn_enregistrer').click(function(){
            if($('#list_pays').val()=='' ||  $('#design').val()==''){
                ...
                $.ajax({
                    url:'enreg_province.php',
                    type:'post',
                    beforeSend:function(){
                        waitingDialog.show('Veuillez patienter svp!');
                    },
                    dataType:'text', 
                    data:{Pays:$('#list_pays').val(), Design:$('#design').val(), token:$('#token').val()},
                    success:function(ret){
                        if(ret==1){
                            Toast.fire({
                                  icon: 'success',
                            ...
                            window.location.replace('afficher_table_province.php?Pays='+$('#Pays').val());
                        }else if(ret==2){
