...
$sheet->setCellValue('A3', "MONTHLY SITE INSPECTIONS LIST");
...
// $sheet->getStyle('C6')->applyFromArray($styleA4);
    ...
    $sheet->SetCellValue('A7', "N°")->SetCellValue('B7', "Site ID & Name")->SetCellValue('C7', "Province")->SetCellValue('D7', "Ref. No")->SetCellValue('E7', "Date")->SetCellValue('F7', "Time In")->SetCellValue('G7', "Time Out");
    $cell_st =[
...
$sheet->setTitle("MONTHLY SITE INSPECTIONS"); //set a title for Worksheet
...
$writer->load($fxls); */
    ...
    header('Content-Disposition: attachment;filename="Monthly_Site_Inspection_List_'.date('d').'_'.date('m').'_'.date('Y').'_'.date('H').'_'.date('i').'_'.date('s').'.xlsx"'); 
