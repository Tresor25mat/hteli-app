...
<html lang="en">
  <head>
    ...
    <title>New Monthly Site Inspection | <?php echo $app_infos['Design_App']; ?></title>
    <!-- CSS files -->
    <!-- DataTables CSS -->
...
<!--                   <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#modal-report" aria-label="Create new report">
                                    ...
                                    <div class="col-md-3" style="margin-bottom: 5px;">
                                      ...
                                      <div class="col-md-3" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="num_ref" type="text" name="num_ref">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-3" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_1" type="text" name="measured_value_1">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_2" type="text" name="measured_value_2">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_3" type="text" name="measured_value_3">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_4" type="text" name="measured_value_4">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_5" type="text" name="measured_value_5">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_6" type="text" name="measured_value_6">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_7" type="text" name="measured_value_7">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_8" type="text" name="measured_value_8">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_9" type="text" name="measured_value_9">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_10" type="text" name="measured_value_10">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_11" type="text" name="measured_value_11">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_12" type="text" name="measured_value_12">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_13" type="text" name="measured_value_13">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_14" type="text" name="measured_value_14">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_15" type="text" name="measured_value_15">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_16" type="text" name="measured_value_16">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_17" type="text" name="measured_value_17">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_18" type="text" name="measured_value_18">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_19" type="text" name="measured_value_19">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_20" type="text" name="measured_value_20">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_21" type="text" name="measured_value_21">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_22" type="text" name="measured_value_22">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_23" type="text" name="measured_value_23">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_24" type="text" name="measured_value_24">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_25" type="text" name="measured_value_25">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
                                ...
                                <div class="row" style="border-top: 1px solid #E6E7E9; margin-top: 10px; padding-top: 10px">
                                    <div class="col-md-6" style="margin-bottom: 5px">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-12">
                                            <input class="form-control" id="measured_value_26" type="text" name="measured_value_26">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6" style="margin-bottom: 5px">
    ...
    //             $('#daterap').val(daterap);
    //             $.ajax({
    //                 url:'enreg_rapport_site.php',
    //                 type:'post',
    //                 dataType:'text', 
    //                 data:{Province:$('#province').val(), Site:$('#ID_Site').val(), Num_Ref:$('#num_ref').val(), Daterap:$('#daterap').val(), Time_in:$('#time_in').val(), Time_out:$('#time_out').val(), token:$('#token').val()},
    ...
    $('#DetailsForm').submit(function(e){
            ...
            var formData = new FormData(this);
            $.ajax({
                    url:'enreg_details_rapport_site.php',
                    type:'post',
                    beforeSend:function(){
                        waitingDialog.show('Veuillez patienter svp!');
                    },
                    ...
                    success:function(retour){
                        ...
                        if(retour==1){
                            ...
                            dateRap = dateRapport.replace(/\//g, "-");
                            window.location.replace('afficher_table_rapport_mensuel_site.php?User='+$('#User').val()+'&siteId='+$('#siteId').val()+'&numRef='+$('#numRef').val()+'&dateRapport='+dateRap);
                        }else{
