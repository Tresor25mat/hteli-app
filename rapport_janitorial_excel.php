...
$sheet->setCellValue('A3', "JANITORIALS, FACILITIES AND ALARMS LIST");
...
// $sheet->getStyle('C6')->applyFromArray($styleA4);
    ...
    $sheet->SetCellValue('A7', "N°")->SetCellValue('B7', "Site ID & Name")->SetCellValue('C7', "Province")->SetCellValue('D7', "Work Order No")->SetCellValue('E7', "Date")->SetCellValue('F7', "Time In")->SetCellValue('G7', "Time Out")->SetCellValue('H7', "Type of site");
    $cell_st =[
...
$sheet->setTitle("JANITORIALS, FACILITIES LIST"); //set a title for Worksheet
...
$writer->load($fxls); */
    ...
    header('Content-Disposition: attachment;filename="Janitorials_Facilities_List_'.date('d').'_'.date('m').'_'.date('Y').'_'.date('H').'_'.date('i').'_'.date('s').'.xlsx"'); 
